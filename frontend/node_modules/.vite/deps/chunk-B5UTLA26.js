...
import {
  createSvgIcon,
  init_createSvgIcon
} from "./chunk-XW475VU7.js";
import {
  Modal_default,
  getScrollbarSize,
  getTransitionProps,
  reflow
} from "./chunk-X4K7KB4V.js";
import {
  ...
  ownerDocument,
  ownerWindow
} from "./chunk-EZKRYWUO.js";
import {
  useTheme
} from "./chunk-DYR27GYN.js";
import {
  Paper_default
} from "./chunk-ZGYEGGFQ.js";
import {
  capitalize,
  init_capitalize
} from "./chunk-VGBOLJLX.js";
import {
  Transition_default
} from "./chunk-AEKBZRAE.js";
import {
  deprecatedPropType,
  init_deprecatedPropType
} from "./chunk-RIXISCXX.js";
import {
  init_setRef,
  init_useForkRef,
  setRef,
...
var Popover = React2.forwardRef(function Popover2(props, ref) {
  ...
  var paperRef = React2.useRef();
  var getAnchorOffset = React2.useCallback(function(contentAnchorOffset) {
  ...
  var getContentAnchorOffset = React2.useCallback(function(element) {
  ...
  var getTransformOrigin = React2.useCallback(function(elemRect) {
  ...
  var getPositioningStyle = React2.useCallback(function(element) {
  ...
  var setPositioningStyles = React2.useCallback(function() {
  ...
  var handlePaperRef = React2.useCallback(function(instance) {
  ...
  React2.useImperativeHandle(action, function() {
    return open ? {
  ...
  }, other), React2.createElement(TransitionComponent, _extends({
    appear: true,
    in: open,
    onEnter,
    onEntered,
  ...
  }), React2.createElement(Paper_default, _extends({
    elevation,
    ref: handlePaperRef
  }, PaperProps, {
...
true ? Popover.propTypes = {
   ...
   */
  anchorEl: chainPropTypes(import_prop_types2.default.oneOfType([HTMLElementType, import_prop_types2.default.func]), function(props) {
   ...
   */
  container: import_prop_types2.default.oneOfType([HTMLElementType, import_prop_types2.default.instanceOf(React2.Component), import_prop_types2.default.func]),
  /**
   ...
   * anchor element.
   */
  getContentAnchorEl: import_prop_types2.default.func,
  /**
...
var Popover_default = withStyles_default(styles2, {
  name: "MuiPopover"
})(Popover);
...
var useEnhancedEffect = typeof window === "undefined" ? React3.useEffect : React3.useLayoutEffect;
var MenuList = React3.forwardRef(function MenuList2(props, ref) {
  ...
  var textCriteriaRef = React3.useRef({
    keys: [],
    repeating: true,
  ...
  React3.useImperativeHandle(actions, function() {
    return {
  ...
  var handleOwnRef = React3.useCallback(function(instance) {
    listRef.current = ReactDOM2.findDOMNode(instance);
  }, []);
  var handleRef = useForkRef(handleOwnRef, ref);
  var activeItemIndex = -1;
  React3.Children.forEach(children, function(child, index) {
  ...
  return React3.createElement(List_default, _extends({
    role: "menu",
    ref: handleRef,
    className,
...
var Menu = React4.forwardRef(function Menu2(props, ref) {
  ...
  var menuListActionsRef = React4.useRef(null);
  var contentAnchorRef = React4.useRef(null);
  ...
  var activeItemIndex = -1;
  React4.Children.map(children, function(child, index) {
  ...
  var items = React4.Children.map(children, function(child, index) {
    if (index === activeItemIndex) {
  ...
  return React4.createElement(Popover_default, _extends({
    getContentAnchorEl,
    ...
    ref,
    transitionDuration
  }, other), React4.createElement(MenuList_default, _extends({
...
var Menu_default = withStyles_default(styles3, {
  name: "MuiMenu"
})(Menu);
...
var SelectInput = React5.forwardRef(function SelectInput2(props, ref) {
  ...
  var _React$useState = React5.useState(null), displayNode = _React$useState[0], setDisplayNode = _React$useState[1];
  var _React$useRef = React5.useRef(openProp != null), isOpenControlled = _React$useRef.current;
  var _React$useState2 = React5.useState(), menuMinWidthState = _React$useState2[0], setMenuMinWidthState = _React$useState2[1];
  var _React$useState3 = React5.useState(false), openState = _React$useState3[0], setOpenState = _React$useState3[1];
  var handleRef = useForkRef(ref, inputRefProp);
  React5.useImperativeHandle(handleRef, function() {
    return {
  ...
  return React5.createElement(React5.Fragment, null, React5.createElement("div", _extends({
  ...
  ) : display), React5.createElement("input", _extends({
    ...
    autoFocus
  }, other)), React5.createElement(IconComponent, {
  ...
  }), React5.createElement(Menu_default, _extends({
    id: "menu-".concat(name || ""),
...
init_createSvgIcon();
var ArrowDropDown_default = createSvgIcon(React6.createElement("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
true ? TextareaAutosize.propTypes = {
   ...
   */
  rows: deprecatedPropType(import_prop_types6.default.oneOfType([import_prop_types6.default.number, import_prop_types6.default.string]), "Use `minRows` instead."),
  /**
   * Maximum number of rows to display.
   * @deprecated Use `maxRows` instead.
   */
  rowsMax: deprecatedPropType(import_prop_types6.default.oneOfType([import_prop_types6.default.number, import_prop_types6.default.string]), "Use `maxRows` instead."),
  /**
   * Minimum number of rows to display.
   * @deprecated Use `minRows` instead.
   */
  rowsMin: deprecatedPropType(import_prop_types6.default.oneOfType([import_prop_types6.default.number, import_prop_types6.default.string]), "Use `minRows` instead."),
  /**
   * @ignore
   */
...
true ? InputBase.propTypes = {
   ...
   * @deprecated Use `maxRows` instead.
   */
  rowsMax: import_prop_types7.default.oneOfType([import_prop_types7.default.number, import_prop_types7.default.string]),
  /**
   * Minimum number of rows to display.
   * @deprecated Use `minRows` instead.
   */
  rowsMin: import_prop_types7.default.oneOfType([import_prop_types7.default.number, import_prop_types7.default.string]),
  /**
...
var Input = React9.forwardRef(function Input2(props, ref) {
...
Input.muiName = "Input";
var Input_default = withStyles_default(styles7, {
  name: "MuiInput"
})(Input);
...
var NativeSelectInput = React10.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return React10.createElement(React10.Fragment, null, React10.createElement("select", _extends({
    className: clsx_m_default(
      classes.root,
      // TODO v5: merge root and select
      classes.select,
    ...
    disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : React10.createElement(IconComponent, {
...
var defaultInput = React11.createElement(Input_default, null);
var NativeSelect = React11.forwardRef(function NativeSelect2(props, ref) {
  ...
  return React11.cloneElement(input, _extends({
...
var NativeSelect_default = withStyles_default(styles9, {
...
var FilledInput = React12.forwardRef(function FilledInput2(props, ref) {
  var disableUnderline = props.disableUnderline, classes = props.classes, _props$fullWidth = props.fullWidth, fullWidth = _props$fullWidth === void 0 ? false : _props$fullWidth, _props$inputComponent = props.inputComponent, inputComponent = _props$inputComponent === void 0 ? "input" : _props$inputComponent, _props$multiline = props.multiline, multiline = _props$multiline === void 0 ? false : _props$multiline, _props$type = props.type, type = _props$type === void 0 ? "text" : _props$type, other = _objectWithoutProperties(props, ["disableUnderline", "classes", "fullWidth", "inputComponent", "multiline", "type"]);
  return React12.createElement(InputBase_default, _extends({
    classes: _extends({}, classes, {
      root: clsx_m_default(classes.root, !disableUnderline && classes.underline),
      underline: null
    }),
...
var FilledInput_default = withStyles_default(styles11, {
  name: "MuiFilledInput"
})(FilledInput);
...
var NotchedOutline = React13.forwardRef(function NotchedOutline2(props, ref) {
  ...
  if (label !== void 0) {
    return React13.createElement("fieldset", _extends({
      "aria-hidden": true,
      className: clsx_m_default(classes.root, className),
      ref,
      style
    }, other), React13.createElement("legend", {
      className: clsx_m_default(classes.legendLabelled, notched && classes.legendNotched)
    }, label ? React13.createElement("span", null, label) : React13.createElement("span", {
      dangerouslySetInnerHTML: {
        __html: "&#8203;"
      }
    })));
...
var NotchedOutline_default = withStyles_default(styles13, {
...
var OutlinedInput = React14.forwardRef(function OutlinedInput2(props, ref) {
  ...
  return React14.createElement(InputBase_default, _extends({
    renderSuffix: function renderSuffix(state) {
      return React14.createElement(NotchedOutline_default, {
...
var OutlinedInput_default = withStyles_default(styles15, {
  name: "MuiOutlinedInput"
})(OutlinedInput);

// node_modules/@material-ui/core/esm/Select/Select.js
var styles17 = styles9;
var _ref = React15.createElement(Input_default, null);
var _ref2 = React15.createElement(FilledInput_default, null);
var Select = React15.forwardRef(function Select2(props, ref) {
  ...
  var InputComponent = input || {
    standard: _ref,
    outlined: React15.createElement(OutlinedInput_default, {
      label,
      labelWidth
    }),
    filled: _ref2
  }[variant];
  return React15.cloneElement(InputComponent, _extends({
...
var Select_default = withStyles_default(styles17, {
  name: "MuiSelect"
})(Select);
...
//# sourceMappingURL=chunk-B5UTLA26.js.map
